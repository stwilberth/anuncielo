...
mount(function ($store_url) {
    //si el usuario no tiene una tienda, no puede crear un producto
    //if (!Store::where('user_id', Auth::id())->exists()) {
        //session()->flash('message-type', 'error');
        //session()->flash('message', 'No puedes crear un producto sin una tienda.');
    ...
    //obtener la store como parametro del componente

    //si el usuario tiene una tienda, no puede crear otra
    //if (Product::where('user_id', Auth::id())->exists()) {
        //session()->flash('message-type', 'error');
                ...
                <div>
                    <form wire:submit.prevent="create" class="mx-auto">
                        <div class="mb-4">
                            ...
                            <input wire:model="url" type="text" id="url" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="mb-4">
                            ...
                            <input wire:model="published" type="checkbox" id="public" class="mt-1 focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
