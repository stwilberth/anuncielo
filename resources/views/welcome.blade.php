            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <section class="bg-white dark:bg-gray-900">
                    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">¡Potencia tu negocio con Anuncielo.com!</h1>
                        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">
                            "Anuncielo.com te permite crear tu tienda virtual en minutos. Muestra tus productos, conecta con clientes y gestiona ventas de manera fácil. Aunque no contamos con pasarelas de pago integradas, ofrecemos un espacio seguro para que los vendedores gestionen sus ventas y acuerden métodos de pago fuera del sitio."
                        </p>
